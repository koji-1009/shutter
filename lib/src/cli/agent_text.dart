// Mirror of `doc/agent.md`, printed by `shutter agent`. Kept byte-identical by
// test/cli/text_parity_test.dart; edit the markdown, then copy it here.
...
* Always set `size`: small and content-fitting for a widget, `390x844` for a screen.
